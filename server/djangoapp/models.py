...
class CarMake(models.Model):
    ...
    def __str__(self):
        return "{}, description:{}".format(self.name, self.description)
...
class CarModel(models.Model):
    ...
    model_type = models.CharField(null=False, max_length=20, choices=MODEL_OPTIONS, default='sedan')
...
class DealerReview:
    def __init__(self, dealership, name,purchase,review,
                purchase_date,car_make,car_model,car_year,id,
                sentiment="neutral" ):
